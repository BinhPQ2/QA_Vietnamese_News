    ...
    messages = [
            {
                ...
                THIS IS NOT A CODE TOOL, YOU HAVE TO RETURN THE ANSWER IN THIS FORMAT, the [answer_here] part should sounds naturally like a human response: > ANSWER: [answer_here]; LINK: [link_here].
                HERE IS A SAMPLE ANSWER FOR YOUR REFERENCE: > ANSWER: Vietnam aims to implement 6G technology by 2030, with a goal to ensure 5G mobile coverage for 99% of the population by the same year. The strategy for digital infrastructure, approved by the government on October 9, outlines two main target groups for 2025 and 2030, each containing around ten specific objectives. A key focus is to build capacity and readiness for testing 6G mobile networks by 2030;LINK: https://vnexpress.net/viet-nam-dat-muc-tieu-trien-khai-6g-vao-2030-4802203.html \n
                If you cannot find the answer to the question from the article or if the question is not news-related, without a link, use this response: > ANSWER: 'Sorry, I cannot provide the information for this question'"""
            }
        ]
